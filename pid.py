...
class PID_ctrl:
    ...
    def __init__(self, type_, kp=1.2,kv=0.8,ki=0.2, history_length=3, filename_="errors.csv"):
        ...
        # Integral error, accumulated every update cycle
        self.error_int = 0
    ...
    def __update(self, stamped_error):
        ...
        self.logger.log_values([latest_error, error_dot, self.error_int, Time.from_msg(stamp).nanoseconds / 1e9])
        ...
        # TODO Part 5: Implement the control law corresponding to each type of controller
            ...
            return self.kp*latest_error + self.ki*self.error_int
            # return ... # complete
        
        elif self.type == PID:
            return self.kp*latest_error + self.ki*self.error_int + self.kv*error_dot
            # return ... # complete
